window.onload = function() {
  var attributeStyleInfo = {
    "rentersseverecostburden_10":{
      colorRamp: ['#edf8e9','#bae4b3','#74c476','#31a354','#006d2c'],
      rangeText: ['<15','15-18','18-21','21-24','>=24']
    },
    "housingunitsowneroccupied_10":{
      colorRamp: ['#eff3ff','#bdd7e7','#6baed6','#3182bd','#08519c'],
      rangeText: ['<55','55-60','60-65','65-70','>=70']
    },
    "foreclosuresper10000_10":{
      colorRamp: ['#fee5d9','#fcae91','#fb6a4a','#de2d26','#a50f15'],
      rangeText: ['<15','15-30','30-45','45-60','>=60']
    }
  }
  var starterChip = attributeStyleInfo.rentersseverecostburden_10.colorRamp;
  var starterLabel = attributeStyleInfo.rentersseverecostburden_10.rangeText;
  for (var i = 0; i < 5; i++){
  ...
  var layerSource = {
    ...
    sublayers: [{
      ...
      cartocss: $('#rentersseverecostburden_10').text(),
      interactivity: "cartodb_id, the_geom, county, state, rentersseverecostburden_10, housingunitsowneroccupied_10, foreclosuresper10000_10"
    }]
  }
...
cartodb.createLayer(map, layerSource)
  ...
  .done(function(layer){
      ...
      cartodb.vis.Vis.addInfowindow(
        map,
        sublayer,
        ['name','rentersseverecostburden_10','housingunitsowneroccupied_10', 'foreclosuresper10000_10'], 
        {
