window.onload = function() {
  var attributeStyleInfo = {
    "energyconsumptionpercapita_10":{
      colorRamp: ['#edf8e9','#bae4b3','#74c476','#31a354','#006d2c'],
      rangeText: ['<275K','275K-324K','324K-361K','361K-423K','>=423K']
    },
    "waterconsumptionperdaypercapita_10":{
      colorRamp: ['#eff3ff','#bdd7e7','#6baed6','#3182bd','#08519c'],
      rangeText: ['<1000','1000-2000','2000-5000','5000-10K','>=10K']
    }
  }
  var starterChip = attributeStyleInfo.energyconsumptionpercapita_10.colorRamp;
  var starterLabel = attributeStyleInfo.energyconsumptionpercapita_10.rangeText;
  for (var i = 0; i < 5; i++){
  ...
  var layerSource = {
    ...
    sublayers: [{
      ...
      cartocss: $('#energyconsumptionpercapita_10').text(),
      interactivity: "cartodb_id, the_geom, county, state, energyconsumptionpercapita_10, waterconsumptionperdaypercapita_10"
    }]
  }
...
cartodb.createLayer(map, layerSource)
  ...
  .done(function(layer){
      ...
      cartodb.vis.Vis.addInfowindow(
        map,
        sublayer,
        ['name','energyconsumptionpercapita_10','waterconsumptionperdaypercapita_10'], 
        {
