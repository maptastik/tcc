window.onload = function() {
  ...
  var layerSource = {
    ...
    sublayers: [{
      ...
      cartocss: $('#healthindex_10').text(),
      interactivity: "cartodb_id, the_geom, name, healthindex_00, healthindex_05, healthindex_08, healthindex_10"
    }]
  }
...
cartodb.createLayer(map, layerSource)
  ...
  .done(function(layer){
      ...
      cartodb.vis.Vis.addInfowindow(
        map,
        sublayer,
        ['name','healthindex_10','healthindex_08','healthindex_05','healthindex_00'], 
        {
