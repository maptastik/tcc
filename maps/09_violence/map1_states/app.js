window.onload = function() {
  var attributeStyleInfo = {
    "traumarelateddeath_10":{
      colorRamp: ['#edf8e9','#bae4b3','#74c476','#31a354','#006d2c'],
      rangeText: ['<45','45-55','55-65','65-75','>=75']
    },
    "violentcrime100k_10":{
      colorRamp: ['#eff3ff','#bdd7e7','#6baed6','#3182bd','#08519c'],
      rangeText: ['<200','200-300','300-400','400-500','>=500']
    },
    "rape100k_10":{
      colorRamp: ['#fee5d9','#fcae91','#fb6a4a','#de2d26','#a50f15'],
      rangeText: ['<20','20-30','30-40','40-50','>=50']
    }
  }
  var starterChip = attributeStyleInfo.traumarelateddeath_10.colorRamp;
  var starterLabel = attributeStyleInfo.traumarelateddeath_10.rangeText;
  for (var i = 0; i < 5; i++){
  ...
  var layerSource = {
    ...
    sublayers: [{
      ...
      cartocss: $('#traumarelateddeath_10').text(),
      interactivity: "cartodb_id, the_geom, county, state, traumarelateddeath_10, violentcrime100k_10, rape100k_10"
    }]
  }
...
cartodb.createLayer(map, layerSource)
  ...
  .done(function(layer){
      ...
      cartodb.vis.Vis.addInfowindow(
        map,
        sublayer,
        ['name','traumarelateddeath_10','violentcrime100k_10', 'rape100k_10'], 
        {
